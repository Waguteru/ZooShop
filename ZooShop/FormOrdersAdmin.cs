...
namespace ZooShop
{
    public partial class FormOrdersAdmin : Form
    {
        ...
        public FormOrdersAdmin(string description, string name, string manufacturer, decimal price, decimal discount, Npgsql.NpgsqlConnection npgsqlConnection,CheckUser user)
        {
            InitializeComponent();
            _user = user;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (NpgsqlCommand cmd = new NpgsqlCommand())
            {
                ...
                FormProductsAdmin productAdmin = new FormProductsAdmin(_user);
                productAdmin.Show();
                this.Close();
            }
        }
        ...
        private void FormOrdersAdmin_Load(object sender, EventArgs e)
        {
            label5.Text = $"{_user.Login}:{_user.Status}";
        }
